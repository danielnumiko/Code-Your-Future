...
export default function BlogPreviewV1() {
    ...
    <section className="bg-black overflow-hidden relative">
      <div className="max-w-viewport mx-auto px-margins pt-slice pb-s">
        ...
        <FadeIn className="mb-l">
          <TextReveal className="font-raleway font-medium text-white text-h2 tracking-tight mb-l" delay={0.05}>
            From our blog.
          </TextReveal>
          <div className="flex items-center justify-between">
            <p className="font-raleway text-white/60 text-base max-w-md leading-relaxed">
            ...
            <div className="flex items-center gap-s flex-shrink-0 ml-l">
              <button
                ...
                style={{ border: '2px solid white', color: 'white', width: 44, height: 44, background: 'transparent', flexShrink: 0 }}
              >
        ...
        >
          {posts.map(post => (
            ...
            >
              ...
              <p className="font-raleway font-medium text-white/60 uppercase tracking-widest text-xs mb-s flex items-center gap-2">
              ...
              <h3
                className="font-raleway font-medium text-white text-h5 leading-snug transition-colors"
