...
export default function TestimonialCarouselV1() {
      ...
      <div className="max-w-viewport mx-auto px-margins py-slice grid lg:grid-cols-2 gap-2xl items-center">
        ...
        <div className="flex flex-col justify-center">
          ...
          <div className="flex items-center gap-s mt-xl">
            <button onClick={prev} aria-label="Previous testimonial" style={btnStyle}>
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true">
                <path d="M10 3L5 8l5 5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            </button>
            <button onClick={next} aria-label="Next testimonial" style={btnStyle}>
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true">
